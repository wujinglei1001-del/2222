...
import { PodcastPlaylist, TranscriptItem } from 'types/content';
import { comments } from './homepage';

const podcast = (index: number) =>
  `${initialConfig.assetsDir}/images/content/details/podcast/${index}.webp`;

export const podcastPlaylist: PodcastPlaylist[] = [
  {
    id: 1,
...
export const recommendedPodcasts: PodcastPlaylist[] = [
  {
    id: 1,
...
export const audioTranscript: TranscriptItem[] = [

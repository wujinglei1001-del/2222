...
export const currentPayrollRun: Record<string, string | number> = {
  start: '2025-03-01',
  end: '2025-03-31',
  payDate: '2025-03-25',
  paySchedule: 'Monthly',
...
export type PayKPI = {
  ...
  title: string;
  value: string;
  icon: IconifyIconProps['icon'] | string;
};

export const paySummaryKpis: PayKPI[] = [
...
export type PayrollCostSummary = {
  period: string;
  stats: {
    netPay: number;
    tax: number;
...
export const payrollCostSummaryData: PayrollCostSummary[] = [
...
export const costSummaryData: Record<string, PayrollCostSummary[]> = {
  previous_year: [
    { period: 'Jan', stats: { netPay: 25, tax: 6, extraPay: 3, otherDeduction: 3 } },
    { period: 'Feb', stats: { netPay: 20, tax: 9, extraPay: 3, otherDeduction: 2 } },
    { period: 'Mar', stats: { netPay: 25, tax: 6, extraPay: 3, otherDeduction: 3 } },

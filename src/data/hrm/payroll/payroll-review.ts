...
export const payrollTotals: PayrollTotal[] = [
  {
    id: 1,
    name: 'Direct Deposit',
    autoPay: 9310.05,
...
export type EmployeeSummary = {
  id: number;
  employee: User & { empId: string };
  totalHours: number;
  totalGross: number;
  totalDeduction: number;
};

export const employeeSummaryData: EmployeeSummary[] = [
  {
    id: 1,
...
export const taxSummaryData: TaxSummary[] = [
  {
    id: 1,

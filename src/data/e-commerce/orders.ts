...
import { InvoiceListAdmin, OrderActivities, OrderDetails, OrderListAdmin } from 'types/ecommerce';
import { Invoice, OrderTrackDetails } from './../../types/ecommerce';
...
export const orderDetailsList: OrderDetails[] = [
  {
    id: '#141135',
    items: [
      {
...
export const orderListAdmin: OrderListAdmin[] = [
  {
    id: '#4544321',
...
export const invoiceListAdmin: InvoiceListAdmin[] = orderListAdmin.map((order) => ({
  ...order,
  invoiceId: `INV-${order.id}`,
}));

export const orderTrackDetails: OrderTrackDetails = {
  id: '#1411241235',
  number: '8646890435',

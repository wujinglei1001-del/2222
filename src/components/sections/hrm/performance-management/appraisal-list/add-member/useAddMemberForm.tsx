...
import { Appraisal, appraisalList } from 'data/hrm/performance-management';
import { User } from 'types/users';
import * as yup from 'yup';

export type AddMemberFormValues = {
  member: Appraisal['member'];
  department: string;
  template: string;
...
export const addMemberFormSchema: yup.ObjectSchema<AddMemberFormValues> = yup.object({

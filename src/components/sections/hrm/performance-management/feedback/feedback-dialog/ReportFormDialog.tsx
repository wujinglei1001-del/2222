...
type ReportFormDialogProps = DialogProps & { feedback: Feedback; onClose: () => void };
...
const ReportFormDialog = ({ feedback, onClose, sx, ...rest }: ReportFormDialogProps) => {
    ...
    <FormProvider {...methods}>
      ...
      >
        <DialogTitle component={Box} sx={{ p: { xs: 3, md: 5 } }}>
          <Stack
            direction="row"
            sx={{ gap: 1, mb: 2, justifyContent: 'space-between', alignItems: 'center' }}
          >

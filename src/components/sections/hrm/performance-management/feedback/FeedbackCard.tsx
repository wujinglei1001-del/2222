...
const formatAppraisalType = (value: string) =>
...
const FeedbackCard = ({ feedback, sx, ...rest }: FeedbackCardProps) => {
  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          <Stack direction="row" sx={{ gap: { xs: 1, sm: 2 }, mb: { xs: 1.5, md: 3 } }}>
            <Stack direction="row" sx={{ gap: { xs: 1, sm: 2 }, flexGrow: 1 }}>
          ...
          <Stack direction={{ xl: 'row' }} sx={{ gap: 1, justifyContent: 'space-between' }}>
            <Typography
              variant="body2"
              sx={[
                {

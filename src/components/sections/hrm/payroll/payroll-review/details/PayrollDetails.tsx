...
const employeeColumns: GridColDef<GridRowModel>[] = [
  {
    field: 'employee',
...
const taxColumns: GridColDef<GridRowModel>[] = [
  {
    field: 'employees',
    headerName: 'Employees',
...
const PayrollDetails = () => {
  const [tab, setTab] = useState<'employee' | 'tax'>('employee');

  const handleTabChange = (_: SyntheticEvent, newValue: 'employee' | 'tax') => {
    setTab(newValue);
  };
  ...
  return (
    <div>
      <Stack direction="row" sx={{ gap: 1, justifyContent: 'space-between', mb: 3 }}>

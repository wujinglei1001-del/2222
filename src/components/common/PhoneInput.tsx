...
const PhoneInput = ({ variant, FlagIconButtonProps, ...props }: PhoneInputProps) => {
...
// Styles
const iconifyStyles = (): CSSProperties => ({
...
const filledInputStyles = (theme: Theme): CSSProperties => ({
...
const outlinedInputStyles = (theme: Theme): CSSProperties => ({
